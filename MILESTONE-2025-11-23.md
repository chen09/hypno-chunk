...
> ⚠️ **历史文档**：本文件记录 2025-11-23 当时的部署状态，作为历史归档保留。
> 此后（2026-04）经过安全加固，生产配置与本文所述有差异：
> - 容器端口不再是 `3000:3000`，改为 `127.0.0.1:3000:3000`
> - `docker-compose.yml` 新增日志轮转、`read_only`、`cap_drop`、`security_opt`、资源限制
>
> **当前事实源**：请参考 `AGENTS.md`（SSOT）、`DEPLOYMENT.md`、`docker-compose.yml`。
